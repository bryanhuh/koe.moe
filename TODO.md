...
- [x] Settings → "Export my data" button: emits JSON of user's rows _(`feat(settings):`)_
- [x] Settings → "Delete my account" button: cascade-deletes user rows + auth user _(`feat(settings):`)_
